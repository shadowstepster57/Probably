...
local Bosses = {
	...
	-------------------------------------------------------------------------------
	-- Throne of Thunder (5.2 Raid)
	-------------------------------------------------------------------------------
	[69465] = true,	-- Jin'rokh the Breaker
	[68476] = true,	-- Horridon
	[69374] = true,	-- Horridon: War-God Jalak
	[69134] = true,	-- Council of Elders: Kazra'jin
	[69078] = true,	-- Council of Elders: Sul the Sandcrawler
	[69131] = true,	-- Council of Elders: Frost King Malakk
	[69132] = true,	-- Council of Elders: High Priestess Mar'li
	[67977] = true,	-- Tortos
	[70212] = true,	-- Megaera: Flaming Head
	[70235] = true,	-- Megaera: Frozen Head
	[70247] = true,	-- Megaera: Venomous Head
	[70252] = true,	-- Megaera: Arcane Head (Heroic)
	[69712] = true,	-- Ji-Kun
	[68036] = true,	-- Durumu the Forgotten
	[69017] = true,	-- Primordius
	[69427] = true,	-- Dark Animus
	[68078] = true,	-- Iron Qon
	[68079] = true,	-- Iron Qon Champion: Ro'shak, the Molten Flare
	[68080] = true,	-- Iron Qon Champion: Quet'zal, the Stormcaller
	[68081] = true,	-- Iron Qon Champion: Dam'ren, the Frozen Sage
	[68905] = true,	-- Twin Consorts: Lu'lin, Mistress of Solitude
	[68904] = true,	-- Twin Consorts: Suen, Mistress of Anger
	[68397] = true,	-- Lei Shen, The Thunder King
	[69473] = true,	-- Ra-Den, Fallen Keeper of Storms

	-------------------------------------------------------------------------------
	-- Siege of Orgrimmar (5.4 Raid)
	-------------------------------------------------------------------------------
	...
	[71859] = true,	-- Kor'kon Dark Shaman: Earthbreaker Haromm
	[71858] = true,	-- Kor'kon Dark Shaman: Wavebinder Kardris
	[71515] = true,	-- General Nazgrim
	[71454] = true,	-- Malkorok
	[73723] = true,	-- Spoils of Pandaria: Jun-Wei
	[73724] = true,	-- Spoils of Pandaria: Zu Yin
	[73725] = true,	-- Spoils of Pandaria: Xiang-Lin
	[71408] = true,	-- Spoils of Pandaria: Kun-Da
	[73948] = true,	-- Spoils of Pandaria: Commander Ik'tal
	[73949] = true,	-- Spoils of Pandaria: Commander Na'kaz
	[73951] = true,	-- Spoils of Pandaria: Commander Tik
	[71409] = true,	-- Spoils of Pandaria: Commander Zak'tar
	[71529] = true,	-- Thok the Bloodthirsty
	[71504] = true,	-- Siegecrafter Blackfuse
	[71161] = true,	-- Paragons of the Klaxxi: Kil'ruk the Wind-Reaver
	[71157] = true,	-- Paragons of the Klaxxi: Xaril the Poisoned Mind
	[71156] = true,	-- Paragons of the Klaxxi: Kaz'tik the Manipulator
	[71155] = true,	-- Paragons of the Klaxxi: Korven the Prime
	[71160] = true,	-- Paragons of the Klaxxi: Iyyokuk the Lucid
	[71154] = true,	-- Paragons of the Klaxxi: Ka'roz the Locust
	[71152] = true,	-- Paragons of the Klaxxi: Skeer the Bloodseeker
	[71158] = true,	-- Paragons of the Klaxxi: Rik'kal the Dissector
	[71153] = true,	-- Paragons of the Klaxxi: Hisek the Swarmkeeper

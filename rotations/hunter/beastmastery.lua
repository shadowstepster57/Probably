...
ProbablyEngine.rotation.register(253, {
  ...
  -- Cooldowns
  { "Bestial Wrath", { "modifier.cooldowns", "player.spell(Kill Command).cooldown = 0" } },
  { "Kill Command", { "pet.exists", "@coreHunter.petInRange" } },
  ...
  { "Focus Fire", { "player.buff(Frenzy).count = 5", "!player.buff(Bestial Wrath)" } },
  { "Glaive Toss" },
  { "Powershot" },
  { "Barrage" },
  { "Dire Beast" },

...
ProbablyEngine.rotation.register(70, {
  ...
  -- Inquisition
  { "Inquisition", { "!player.buff(Inquisition)", "player.holypower >= 3" } },
  { "Inquisition", { "player.buff(Inquisition).duration <= 2", "player.holypower >= 3" } },
    
  --DPS
  {{ -- Runs w/ Avenging Wrath
  { "Templar's Verdict", { "player.holypower = 5", "!modifier.multitarget" } },
  { "Divine Storm", { "player.holypower = 5", "modifier.multitarget" }, "target.range <= 8" },
  { "Hammer of Wrath" },
  { "Execution Sentence", "spell.cooldown(Hammer of Wrath) > 0.2" },
  { "Hammer of the Righteous", { "modifier.multitarget", "spell.cooldown(Hammer of Wrath) > 0.2" } },
  ...
  -- Standard DPS
  { "Templar's Verdict", {"player.holypower = 5", "!modifier.multitarget" } },
  { "Divine Storm", { "player.holypower >= 3", "modifier.multitarget" }, "target.range <= 8" },
